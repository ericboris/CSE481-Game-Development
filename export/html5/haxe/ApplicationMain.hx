...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Herder Demo", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Herder Demo", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Herder Demo";
		app.meta["name"] = "Herder Demo";
